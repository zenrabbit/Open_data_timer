...
## The early bird gets the return: how to decide when to publish data  
...
add ECE considerations now and why EEB is unique or how it can benefit as a discipline and also help the world too.
...
iii. They could find a new use we are even less likely to do. My experience is not extensive here, but most data reuse is for another new purpose not really linked to the field methods so to speak. So, no risk to us of being scooped but you do risk losing attribution and provenance can be tricky or even outright ignored.  
...
v. You are often obligated by funders to publish data, and this takes some to a lot of time depending on the meta-data language. This is time available to spend on other activities like writing the paper.   
